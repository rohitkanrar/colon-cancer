...
final_pairs <-readRDS("Research/RA/colon-cancer/pair_assignment_final_after_check_second.rds")
...
write.csv(main_output, "Research/RA/colon-cancer/pair_assignments_second.csv")